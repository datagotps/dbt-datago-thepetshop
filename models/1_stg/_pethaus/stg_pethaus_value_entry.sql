...
source_general as (
    ...
    left join  {{ source('sql_erp_prod_dbo', 'pethaus_general_trading_dimension_value_437dbf0e_84ff_417a_965d_ed2bb9650972') }} as d on a.global_dimension_2_code = d.code and d.global_dimension_no_ = 2
),
